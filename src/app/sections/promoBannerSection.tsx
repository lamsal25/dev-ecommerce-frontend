...
const DEFAULT_BANNER = {
  id: 'default',
  image: '/watch.jpeg', // Make sure to have this image in your public folder
  // discountText: 'SPECIAL OFFER',
  title: 'Discover Our Exclusive Deals',
  ...
  useEffect(() => {
    const fetchPromotions = async () => {
      try {
        ...
        const response = await API.get('advertisements/getAdsByPosition/homepage_banner/');
